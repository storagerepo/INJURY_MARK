...
commonApp.controller('userContactUsController',function($scope,requestHandler,Flash){
	$scope.init=function(){
		$scope.contactUsForm={"projectId":"CRO","customerType":"ROLE_LAWYER_ADMIN"};
	...
	$scope.saveContactUs=function(){
		...
		requestHandler.postRequest("/mergeContacts.json",$scope.contactUsForm).then(function(){
			Flash.create('success',"&nbsp;&nbsp;&nbsp;&nbsp;Thanks! Our support team will get back to you soon!!!");
			$scope.init();
		});
	};
